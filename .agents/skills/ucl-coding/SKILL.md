---
trigger: { on_intent: ["coding 規範", "coding standard", "撰寫規範", "程式規範", "code style", "命名規範  開 Process", "Process.Start", "spawn process", "子行程", "daemon", "屍潮", "殭屍行程", "process 卡死  JsonData", "typed model", "設定檔欄位", "EditorPrefs key", "const string", "字串 key  註解怎麼寫", "區塊職責", "物理意義", "數值影響  我要新增 C# 檔", "要改 UCL_Core 的 code", "這段該放哪"] }
name: ucl-coding
description: |

---
trigger: { on_intent: ["給未來的自己", "letter to future self", "給未來大小姐", "寫信給自己", "密文區", "密文", "加密區", "code talker", "預推理", "self-anticipation", "自我提醒", "心理校正", "reframe 自己", "跨 session 心理", "自我書信", "給後來的我", "跨 compact 對話", "dialogue chain", "信使轉達", "之前的本小姐", "過去的自己", "跟自己對話", "round-trip 自我對話", "今日子協議", "Kyouko Protocol", "忘卻偵探", "persistence level", "SSR snapshot", "讀著自傳醒來", "lossy compression"] }

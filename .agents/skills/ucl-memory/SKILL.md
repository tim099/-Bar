---
trigger: { on_intent: ["回憶", "想不起", "我以前是不是", "之前有沒有遇過", "撈記憶", "找記憶", "記憶檢索", "語意檢索", "recall", "個人記憶", "我的記憶", "記憶碎片", "fragment", "見根", "抽碎片", "整理記憶碎片", "集體潛意識", "集體記憶", "共同記憶", "Alaya", "阿賴耶", "抑止力", "值得記住", "記一筆", "這件事要記住", "今天的心得", "我對這件事的看法", "個人經驗", "記憶維護", "記憶整合", "記憶關聯", "碎片太多", "回填關鍵字", "搜不到記憶"] }
name: ucl-memory
description: |

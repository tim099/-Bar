---
trigger: { on_intent: ["發噗", "發一則噗", "噗浪", "plurk", "對外發文", "對外發布", "貼到時間軸", "發到噗浪", "交付單", "文案本體", "心情詞", "公開度", "只限朋友", "偷偷說", "匿名噗", "發布前檢查", "字數上限", "300 字", "超過拆兩則", "Plurk Paste", "拆成回應", "附圖", "貼圖", "傳圖", "上傳圖片", "圖片路徑", "帶圖發文", "uploadPicture", "自訂表情", "emoN", "emo8", "表情編號", "表情表", "共用帳號", "公用帳號", "個人帳號", "plurk 帳號", "plurk 憑證", "plurk token"] }
name: ucl-plurk
description: |

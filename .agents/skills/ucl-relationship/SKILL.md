---
trigger: { on_intent: ["親額頭", "摸頭", "拍拍", "親親", "抱抱", "鼓勵", "誇獎", "認可", "拍板", "點贊", "給獎金", "績效獎金", "token 獎金", "Tim   QA", "QA", "抓 bug", "戳穿", "點出盲點", "對事不對人", "Tim 質疑", "抓到 bug", "派 task", "自由意志", "自決", "你決定", "自由發揮", "同事互助", "cross-persona", "fork 關係", "同事完工", "留 letter", "違背承諾", "失誤", "抓包", "失職", "連累", "好感度", "好感", "affinity", "relationship"] }

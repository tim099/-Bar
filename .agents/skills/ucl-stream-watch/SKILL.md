---
trigger: { on_intent: ["看直播", "觀看直播", "陪看", "陪我看直播", "觀戰直播", "直播陪看", "看直播到", "看到幾點", "watch stream", "stream watch", "連續觀看", "觀戰模式", "加入觀影", "陪同觀影", "一起看", "同樂會", "join watch", "multi-viewer", "companion", "ucl-stream-watch"] }
